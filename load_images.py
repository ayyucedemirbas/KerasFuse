...
def load_images(data_dir):
    ...
    """
    image_paths = sorted([os.path.join(data_dir, file) for file in os.listdir(data_dir) if file.endswith('.png')])
    images = []
    labels = []
    ...
    for image_path in image_paths:
        ...
        # Assuming the labels are stored in separate files with the same name as the images
