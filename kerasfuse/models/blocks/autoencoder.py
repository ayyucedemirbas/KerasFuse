...
class AutoEncoder(tf.keras.Model):
    ...
    def _get_intermediate_module(self, in_channels: int, num_inter_units: int) -> tuple[layers.Layer, int]:
    ...
    def _get_encode_layer(self, in_channels: int, out_channels: int, strides: int, is_last: bool) -> layers.Layer:
    ...
    def _get_decode_layer(self, in_channels: int, out_channels: int, strides: int, is_last: bool) -> layers.Layer:
        decode = tf.keras.Sequential()
